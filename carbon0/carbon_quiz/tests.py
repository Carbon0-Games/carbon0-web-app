...
class QuestionModelTest(TestCase):
    ...
    def test_question_model(self):
        self.assertEqual(
            self.questions[1].question_text, "How many miles do you drive a week?"
        )
...
class QuizModelTest(TestCase):
    def test_quiz_model(self):
        quiz = Quiz.objects.create(
            title="Quiz for new user", active_question=1, carbon_value_total=23.2
        )
...
class MissionModelTest(TestCase):
    def test_mission_model(self):
        ...
        mission = Mission(
            title="Recyle More Often",
            action="This mission will encourage users to recyle more often",
            clicks_needed=2,
            learn_more="Recycling helps the planet become more sustainable",
            question=question,
            links=["www.recycle.com", "www.plasticwaste.com"],
        )
...
class AchievementModelTest(TestCase):
    def test_achievement_model(self):
        ...
        achievement = Achievement.objects.create(
            ...
            zeron_name="Recycle Zeron",
            badge_name="Recyle Master",
        )
